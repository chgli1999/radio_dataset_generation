...
# Title: Usrp Tx 3
# Generated: Mon Jan 18 17:08:07 2021
...
class usrp_tx_3(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Usrp Tx 3")
...
def main(top_block_cls=usrp_tx_3, options=None):
    args = parse_args()
    ...
    usrp_addr =  ['addr=192.168.10.18','addr=192.168.10.17','addr=192.168.10.16']
    usrp_samp_rate = args.rate
    assert len(usrp_samp_rate) == 3, 'Error!Need 3 Sample Rate For 3 USRPs'
    signal_num = 3
    # 根据USRP配置参数进行修改
